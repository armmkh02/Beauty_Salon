			...
			<main class="main-content">
							...
							<div class="col-md-4">
								<div class="news">
									...
									<div class="entry-detail">
										<div class="entry-summary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo velit, tempora aut nesciunt. <a href="#" class="more-icon"><img src="{{ asset('them-forth/images/arrow.png') }}"></a></div>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="news">
									...
									<div class="entry-detail">
										<div class="entry-summary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum quo esse vero ipsa architecto <a href="#" class="more-icon"><img src="{{ asset('them-forth/images/arrow.png') }}"></a></div>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="news">
									...
									<div class="entry-detail">
										<div class="entry-summary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio, corporis,  <a href="#" class="more-icon"><img src="{{ asset('them-forth/images/arrow.png') }}"></a></div>
									</div>
								</div>
							</div>
						</div> <!-- .row -->
				...
				<div class="fullwidth-block features-section">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="feature">
									<img src="{{ asset('them-forth/images/icon-1.png') }}" class="feature-image">
							...
							<div class="col-md-3">
								<div class="feature">
									<img src="{{ asset('them-forth/images/icon-2.png') }}" class="feature-image">
							...
							<div class="col-md-3">
								<div class="feature">
									<img src="{{ asset('them-forth/images/icon-3.png') }}" class="feature-image">
							...
							<div class="col-md-3">
								<div class="feature">
									<img src="{{ asset('them-forth/images/icon-4.png') }}" class="feature-image">
				...
				<div class="fullwidth-block team-section">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{ asset('them-forth/dummy/person-1.jpg') }}"></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{ asset('them-forth/dummy/person-2.jpg') }}"></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{ asset('them-forth/dummy/person-3.jpg') }}"></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{ asset('them-forth/dummy/person-4.jpg') }}"></figure>
				...
				<div class="fullwidth-block information-section">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-4">
								<figure><img src="{{ asset('them-forth/dummy/figure-1.jpg') }}" ></figure>
							</div>
							<div class="col-md-4">
