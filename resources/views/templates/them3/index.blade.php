      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="nonloop-block-13 owl-carousel d-flex">
            ...
            <div class="item-1 h">
              <img src="{{ asset('them-three/images/img_2.jpg') }}" alt="Image" class="img-fluid">
              <div class="item-1-contents">
                <h3>Hair Styling</h3>
                <ul>
            ...
            <div class="item-1 h">
              <img src="{{ asset('them-three/images/img_3.jpg') }}" alt="Image" class="img-fluid">
              <div class="item-1-contents">
    ...
    <div class="container">
      ...
      <div class="row hair-style">
        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
          <a href="#" class="place">
            <img src="{{ asset('them-three/images/img_1.jpg') }}" alt="Image placeholder">
            <h2>Beard Shaving</h2>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
          <a href="#" class="place">
            <img src="{{ asset('them-three/images/img_2.jpg') }}" alt="Image placeholder">
            <h2>Crew Cut</h2>
            <span>$50.00 only</span>
          </a>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
          <a href="#" class="place">
            <img src="{{ asset('them-three/images/img_3.jpg') }}" alt="Image placeholder">
            <h2>Beard Trim</h2>
            <span>$50.00 only</span>
          </a>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 mb-4 mb-lg-0">
          <div class="testimonial-2">
            <div class="d-flex v-card align-items-center mb-4">
              <img src="{{ asset('them-three/images/person_1.jpg') }}" alt="Image" class="img-fluid mr-3">
        ...
        <div class="col-lg-4 mb-4 mb-lg-0">
          <div class="testimonial-2">
            <div class="d-flex v-card align-items-center mb-4">
              <img src="{{ asset('them-three/images/person_2.jpg') }}" alt="Image" class="img-fluid mr-3">
        ...
        <div class="col-lg-4 mb-4 mb-lg-0">
          <div class="testimonial-2">
            <div class="d-flex v-card align-items-center mb-4">
              <img src="{{ asset('them-three/images/person_3.jpg') }}" alt="Image" class="img-fluid mr-3">
