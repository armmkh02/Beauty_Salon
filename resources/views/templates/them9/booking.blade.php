  ...
  <div class="row">
    <div class="col-md-4 col-lg-3 mb-4 mb-md-0">
      ...
      <div class="media contact-info">
        ...
        <div class="media-body">
          <h3><a href="tel:454545654">Full Name:Fabio Marquez</a></h3>
          <p>Service:Barber</p>
        </div>
      </div>
      <div class="media contact-info">
        ...
        <div class="media-body">
          <h3><a href="tel:454545654">Buttonwood, California.</a></h3>
      ...
      <form action="#/" class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
        <div class="row">
          <div class="col-lg-5">
            ...
            <div class="form-group">
              <input class="form-control" name="phone" id="phone" type="text" placeholder="Enter Phone Number(+1)">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <select  name="service" id="service">
                ...
                <option value="audi">Audidsfffffffff</option>
            </select>
