...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        <div class="img mb-4" style="background-image: url(/them-eight/images/person_1.jpg);"></div>
                ...
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        <div class="img mb-4" style="background-image: url(/them-eight/images/person_2.jpg);"></div>
                        <div class="info text-center">
                ...
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        <div class="img mb-4" style="background-image: url(/them-eight/images/person_3.jpg);"></div>
                        <div class="info text-center">
                ...
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        <div class="img mb-4" style="background-image: url(/them-eight/images/person_4.jpg);"></div>
                        <div class="info text-center">
            ...
            <div class="row">
                <div class="col-md-4 ftco-animate">
                    <a href="#" class="work-entry">
                        <img src="{{ asset('them-eight/images/work-1.jpg') }}" class="img-fluid" alt="Colorlib Template">
                ...
                <div class="col-md-4 ftco-animate">
                    <a href="#" class="work-entry">
                        <img src="{{ asset('them-eight/images/work-2.jpg') }}" class="img-fluid" alt="Colorlib Template">
                        <div class="info d-flex align-items-center">
                            <div>
                                <div class="icon mb-4 d-flex align-items-center justify-content-center">
                                    <span class="icon-search"></span>
                ...
                <div class="col-md-4 ftco-animate">
                    <a href="#" class="work-entry">
                        <img src="{{ asset('them-eight/images/work-3.jpg') }}" class="img-fluid" alt="Colorlib Template">
                        <div class="info d-flex align-items-center">
                            <div>
                                <div class="icon mb-4 d-flex align-items-center justify-content-center">
                                    <span class="icon-search"></span>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="col-md-3 ftco-animate">
                            <a href="#" class="partner-entry">
                                <img src="{{ asset('them-eight/images/partner-1.jpg') }}" class="img-fluid" alt="Colorlib template">
                            </a>
                        </div>
                        <div class="col-md-3 ftco-animate">
                            <a href="#" class="partner-entry">
                                <img src="{{ asset('them-eight/images/partner-2.jpg') }}" class="img-fluid" alt="Colorlib template">
                            </a>
                        </div>
                        <div class="col-md-3 ftco-animate">
                            <a href="#" class="partner-entry">
                                <img src="{{ asset('them-eight/images/partner-3.jpg') }}" class="img-fluid" alt="Colorlib template">
                            </a>
                        </div>
                        <div class="col-md-3 ftco-animate">
                            <a href="#" class="partner-entry">
                                <img src="{{ asset('them-eight/images/partner-4.jpg') }}" class="img-fluid" alt="Colorlib template">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="col-md-4 d-flex ftco-animate">
                ...
                <a href="blog-single.html" class="block-20" style="background-image: url(/them-eight/'images/image_1.jpg');">
                </a>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                <a href="blog-single.html" class="block-20" style="background-image: url(/them-eight/'images/image_2.jpg');">
                </a>
                <div class="text py-4 d-block">
                    <div class="meta">
                    <div><a href="#">Sept 10, 2018</a></div>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                <a href="blog-single.html" class="block-20" style="background-image: url(/them-eight/'images/image_3.jpg');">
                </a>
                <div class="text py-4 d-block">
                    <div class="meta">
                    <div><a href="#">Sept 10, 2018</a></div>
