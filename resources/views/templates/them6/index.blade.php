    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single_service">
                     <div class="service_thumb">
                         <img src="{{ asset('them-six/img/service/1.png') }}" alt="">
                     </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_service">
                     <div class="service_thumb">
                         <img src="{{ asset('them-six/img/service/2.png') }}" alt="">
                     </div>
                     <div class="service_content text-center">
                        <div class="icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_service">
                     <div class="service_thumb">
                         <img src="{{ asset('them-six/img/service/3.png') }}" alt="">
                     </div>
                     <div class="service_content text-center">
                        <div class="icon">
                        ...
                        <div class="single_prising">
                            ...
                            <div class="single_service">
                                <div class="service_inner">
                                    <div class="thumb">
                                        <img src="{{ asset('them-six/img/prising/1.png') }}" alt="">
                                    </div>
                                </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single_team_member">
                    <div class="team_thumb">
                        <img src="{{ asset('them-six/img/team/1.png') }}" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_team_member">
                    <div class="team_thumb">
                        <img src="{{ asset('them-six/img/team/2.png') }}" alt="">
                    </div>
                    <div class="member_info text-center">
                        <h3>Jems Smith</h3>
                        <p>Junior Barber</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_team_member">
                    <div class="team_thumb">
                        <img src="{{ asset('them-six/img/team/3.png') }}" alt="">
                    </div>
                    <div class="member_info text-center">
                            ...
                            <div class="col-lg-7 col-md-10">
                                <div class="single_testmonial text-center">
                                    ...
                                    <div class="testmonial_author">
                                        <div class="thumb">
                                            <img src="{{ asset('them-six/img/testmonial/1.png') }}" alt="">
                                        </div>
