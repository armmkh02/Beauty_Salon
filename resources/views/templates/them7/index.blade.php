            ...
            <div class="col-lg-12">
                <div class="single_offer_part">
                    <div class="single_offer">
                        <img src="{{ asset('them-seven/img/offer_img_1.png') }}" alt="offer_img_1">
                        <div class="hover_text">
                            <img src="{{ asset('them-seven/img/icon/cutter.svg') }}" alt="#">
                ...
                <div class="single_offer_part">
                    <div class="single_offer">
                        <img src="{{ asset('them-seven/img/offer_img_2.png') }}" alt="offer_img_1">
                        <div class="hover_text">
                            <img src="{{ asset('them-seven/img/icon/cutter.svg') }}" alt="#">
                            <h2>Best Price</h2>
                            <p>Winged day grass creepeth us second signs </p>
                ...
                <div class="single_offer_part">
                    <div class="single_offer">
                        <img src="{{ asset('them-seven/img/offer_img_3.png') }}" alt="offer_img_1">
                        <div class="hover_text">
                            <img src="{{ asset('them-seven/img/icon/cutter.svg') }}" alt="#">
                ...
                <div class="single_offer_part">
                    <div class="single_offer">
                        <img src="{{ asset('them-seven/img/offer_img_4.png') }}" alt="offer_img_1">
                        <div class="hover_text">
                            <img src="{{ asset('them-seven/img/icon/cutter.svg') }}" alt="#">
        ...
        <div class="row align-items-center">
            <div class="col-md-6 col-lg-6">
                <div class="single_pricing_item">
                    <img src="{{ asset('them-seven/img/pricing_img/pricing_img_1.png') }}" alt="">
                ...
                <div class="single_pricing_item">
                    <img src="{{ asset('them-seven/img/pricing_img/pricing_img_2.png') }}" alt="">
                    <div class="single_pricing_text">
                        <h5>Hair Color</h5>
                        <h6>$10.00</h6>
                        <p>Their days lesser and every firmament</p>
                ...
                <div class="single_pricing_item">
                    <img src="{{ asset('them-seven/img/pricing_img/pricing_img_3.png') }}" alt="">
                    <div class="single_pricing_text">
                        <h5>Hair Straight</h5>
                        <h6>$10.00</h6>
                        <p>Their days lesser and every firmament</p>
                ...
                <div class="single_pricing_item">
                    <img src="{{ asset('them-seven/img/pricing_img/pricing_img_4.png') }}" alt="">
                    <div class="single_pricing_text">
                        <h5>Shampoo</h5>
                        <h6>$10.00</h6>
                        <p>Their days lesser and every firmament</p>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="single_pricing_item">
                    <img src="{{ asset('them-seven/img/pricing_img/pricing_img_5.png') }}" alt="">
                    <div class="single_pricing_text">
                        <h5>Hair Wash</h5>
                        <h6>$10.00</h6>
                        <p>Their days lesser and every firmament</p>
                ...
                <div class="single_pricing_item">
                    <img src="{{ asset('them-seven/img/pricing_img/pricing_img_6.png') }}" alt="">
                    <div class="single_pricing_text">
                        <h5>Hair Shave</h5>
                        <h6>$10.00</h6>
                        <p>Their days lesser and every firmament</p>
                ...
                <div class="single_pricing_item">
                    <img src="{{ asset('them-seven/img/pricing_img/pricing_img_7.png') }}" alt="">
                    <div class="single_pricing_text">
                        <h5>Men’s Facial</h5>
                        <h6>$10.00</h6>
                        <p>Their days lesser and every firmament</p>
                ...
                <div class="single_pricing_item">
                    <img src="{{ asset('them-seven/img/pricing_img/pricing_img_8.png') }}" alt="">
                    <div class="single_pricing_text">
                        <h5>Wedding Style</h5>
                        <h6>$10.00</h6>
                        <p>Their days lesser and every firmament</p>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4">
                <div class="single_blog_item">
                    <div class="single_blog_img">
                        <img src="{{ asset('them-seven/img/artist/artist_1.png') }}" alt="artist">
                    </div>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="single_blog_item">
                    <div class="single_blog_img">
                            <img src="{{ asset('them-seven/img/artist/artist_2.png') }}" alt="artist">
                    </div>
                    <div class="single_text">
                        <div class="single_blog_text text-center">
                            <h3>Fred Macyard</h3>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="single_blog_item">
                    <div class="single_blog_img">
                            <img src="{{ asset('them-seven/img/artist/artist_3.png') }}" alt="artist">
                    </div>
                    <div class="single_text">
                        <div class="single_blog_text text-center">
                            <h3>Justin Stuard</h3>
